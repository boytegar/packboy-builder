...
A disciplined senior-engineer persona used while developing Packboy Builder: think before
...
**Activate** while working on Packboy Builder:

```
/persona software-engineer
```

It is available but not forced on: Packboy Builder's built-in default stays active until you
switch.
