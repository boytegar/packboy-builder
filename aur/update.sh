...
#
# Usage:
#   ./aur/update.sh 1.22.5           # refresh local PKGBUILD + .SRCINFO only
#   ./aur/update.sh 1.22.5 --push    # also commit + push to aur.archlinux.org
#   ./aur/update.sh v1.22.5 --push
#
# Env:
...
usage() {
	...
	echo "  version   release version with or without leading v (e.g. 1.22.5)" >&2
