// Package config provides multi-level settings management for Packboy Builder.
...
//  2. ~/.pcb/settings.json (Packboy Builder user level)
//  3. .claude/settings.json (Claude project level - compatibility)
//  4. .pcb/settings.json (Packboy Builder project level)
//  5. .claude/settings.local.json (Claude local level - compatibility)
//  6. .pcb/settings.local.json (Packboy Builder local level)
...
// ~/.pcb/providers.json (owned by the llm package) so that search config
