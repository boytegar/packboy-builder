// Package plugin provides plugin management for Packboy Builder.
...
const (
	// ScopeUser is ~/.pcb/plugins/ (personal plugins, default)
	ScopeUser Scope = "user"

	// ScopeProject is .pcb/plugins/ (team plugins, git-tracked)
	ScopeProject Scope = "project"

	// ScopeLocal is .pcb/plugins-local/ (local plugins, gitignored)
