...
// pcb's existing user/project scopes — ~/.pcb/skills/<name>/ and
// ./.pcb/skills/<name>/ — distinguished by the origin frontmatter field, not a
// subdirectory.
...
// dirFor — better than silently aliasing user-scope onto cwd/.pcb/skills.
...
// ReloadAfterPluginChange. The L1 reviewer mutates ~/.pcb/skills and
// ./.pcb/skills mid-session via skill_manage; a registry-backed Inventory
