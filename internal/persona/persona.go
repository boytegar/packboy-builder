...
//
// The "default" persona is virtual: it represents Packboy Builder's built-in prompt with
...
// selection and "default" are equivalent — both mean "use Packboy Builder's built-ins".
...
const (
	...
	ScopeUser                 // ~/.pcb/personas/
	ScopeProject              // .pcb/personas/  (overrides user)
)
...
type Persona struct {
	...
	// means "use Packboy Builder's built-in default for that part".
	Identity string
	Behavior string
	Rules    string
...
func DefaultPersona() *Persona {
	return &Persona{
		Name:        DefaultName,
		Description: "Built-in Packboy Builder persona — software engineering generalist",
		Scope:       ScopeBuiltin,
	}
}
