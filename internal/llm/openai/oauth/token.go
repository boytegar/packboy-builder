...
//
// It lets a user with a ChatGPT Plus/Pro/Business plan drive pcb's OpenAI
...
// so a headless `pcb login` command could reuse it later.
package oauth
...
import (
	...
	"github.com/boytegar/packboy-builder/internal/secret"
)
