...
import (
	...
	_ "github.com/boytegar/packboy-builder/internal/tool/registry" // registers built-in schemas used by tool.Set.Tools
)
...
// wires these via blank imports in cmd/pcb/main.go.)
func init() {
