// Package subagent provides subagent execution for Packboy Builder.
...
const (
	...
	// minMaxSteps prevents unusably short subagent runs when an explicit
	// step cap is requested via max_steps. 0 (unset) means unlimited.
	minMaxSteps = 10
)
