...
// brandMark renders the "< Packboy ✦ />" wordmark — teal brackets/word (the shared
...
func brandMark() string {
	return brandWordStyle.Render("< Packboy") + " " + brandStarStyle.Render("✦") + " " + brandWordStyle.Render("/>")
}
