...
const (
	ScopeUser    Scope = "user"    // ~/.pcb/mcp.json (global)
	ScopeProject Scope = "project" // ./.pcb/mcp.json (team shared)
	ScopeLocal   Scope = "local"   // ./.pcb/mcp.local.json (personal, git-ignored)
)
