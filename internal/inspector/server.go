// Package inspector serves the pcb session transcripts to a local web
...
import (
	...
	"github.com/boytegar/packboy-builder/internal/inspector/ui"
...
type Server struct {
	projectDir string // .../.pcb/projects/<encoded-cwd>
	mux        *http.ServeMux
