...
// the structures used in pcb system prompts: headings, paragraphs, lists,
...
function renderMarkdown(src) {
  ...
  while (i < lines.length) {
    ...
    // pcb system prompts use these as section dividers for structured
...
// `pcb` in another terminal) show up without a manual refresh. 2s feels
