---
name: graph
description: Graph engineering — knowledge graphs (ontology, extraction, fusion, GraphRAG) and task graphs (parallel fan-out, verifier separation, stop rule, human gates). Build a graph, extract entities/relations, design an ontology, or learn the 9-stage pipeline.
