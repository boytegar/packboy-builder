...
func TestRecorderWritesRequestedAndRespondedPerTurn(t *testing.T) {
	...
	rec.OnAgentEvent(core.Event{Type: core.PostInfer, Source: "main", Data: &core.InferResponse{
		StopReason: core.StopEndTurn, Usage: core.Usage{InputTokens: 42, OutputTokens: 8, CacheReadTokens: 10},
	}})
	...
	if resp.Usage == nil || resp.Usage.PromptTokens != 52 || resp.Usage.CompletionTokens != 8 {
