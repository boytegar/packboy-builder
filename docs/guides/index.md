...
| Guide | Task |
|---|---|
| [`getting-started`](getting-started.md) | Install, build, and run Packboy Builder for the first time. |
| [`inspector`](inspector.md) | Replay session transcripts with `pcb inspector`. |
