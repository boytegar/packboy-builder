---
package: github.com/boytegar/packboy-builder/internal/subagent
layer: feature
---
...
| Caller | Methods used |
|---|---|
| `cmd/pcb agent` | `Get` (CLI argument validation) |
...
- `loader.go` — reads markdown agent definitions from `.pcb/agents/`
