---
package: github.com/boytegar/packboy-builder/internal/selflearn
layer: feature
---

# selflearn

Runs Packboy Builder's background self-learning pass: after a turn, a restricted fork
...
This package deliberately writes only to Packboy Builder-managed durable state: project
...
mechanism. `PCB_DISABLE_SELF_LEARN=1` is a hard runtime switch: it suppresses
...
- `SkillManager` reads and writes Packboy Builder skill directories directly so the review
