---
package: github.com/boytegar/packboy-builder/internal/mcp
layer: feature
---
...
MCP is how Packboy Builder talks to **external** tool providers (file system
...
Config lives at `<project>/.pcb/mcp.json` (Packboy Builder) or
...
| **ConfigStore** — load / edit / save server definitions | free functions `PrepareServerEdit` / `ApplyServerEdit` | `pcb mcp edit` CLI subcommand |
