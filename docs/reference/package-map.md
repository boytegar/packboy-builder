...
| --- | --- | --- |
| `cmd/pcb` | `cmd` | Main CLI binary. Parses flags, initializes runtime, wires subcommands. |
...
| `internal/confdir` | `infrastructure` | Shared `.pcb` configuration directory naming helper. |
