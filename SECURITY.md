...
If you discover a security vulnerability in Packboy Builder, please report it
...
Packboy Builder is a CLI tool that:

- Reads and writes files to your local filesystem
- Sends prompts and code context to LLM providers (Anthropic, OpenAI, Google)
- Stores session transcripts locally in `~/.pcb/`

**Do not** use Packboy Builder with untrusted extensions, MCP servers, or hooks
without auditing them first.

[advisories]: https://github.com/boytegar/packboy-builder/security/advisories
